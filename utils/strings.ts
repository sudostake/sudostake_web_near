...
export const STRINGS = {
  ...
  ownerLoanTermEndsSoon: "Loan term ends soon",
  ownerLoanTermEndsIn: (countdown: string) => `Loan term ends in ${countdown}`,
  ownerLoanTermEnded: "Loan term ended",
  ownerRepayCountdownHint: "Repay before this timer hits zero to avoid liquidation.",
  ownerExactExpiryLabel: "Exact expiry",
  // Common actions
  ...
  liquidationGuideNote: "You can now begin or continue the liquidation process. This will walk you through the steps to submit the on-chain claim processing call.",
  close: "Close",
  ...
  reqLenderOnly: "You must be the lender or vault owner of this loan.",
  ...
  safetyContractChecks: "The smart contract verifies you are the lender or vault owner and that the loan is eligible for liquidation.",
  ...
  expiredRepayWarning: "Loan expired. Repayment is possible until liquidation starts.",
  ...
  sourceVaultBalanceNow: "Vault balance (now)",
  sourceMaturedUnbonding: "Matured (claimable now)",
  maturedClaimableNow: "Matured (now)",
  ...
  loanDeadlineLabel: "Loan deadline",
  loanDeadlineCountdown: (countdown: string) => `${countdown} remaining`,
