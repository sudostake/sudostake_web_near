...
export function ActionButtons({ onDeposit, onWithdraw, onTransfer, disabled }: ActionButtonsProps) {
  ...
  return (
    <section className="grid grid-cols-1 gap-2 sm:grid-cols-3" aria-label="Vault actions">
      <Button onClick={onDeposit} disabled={disabled} size="sm" className={buttonClass}>
      ...
      <Button variant="secondary" onClick={onWithdraw} disabled={disabled} size="sm" className={buttonClass}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4" aria-hidden="true">
      ...
      <Button variant="secondary" onClick={onTransfer} disabled={disabled} size="sm" className={buttonClass}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4" aria-hidden="true">
